...
<select id="sigungus" name="sigungus">
...
<br>
<select id="broadCategorys" name="broadCategorys">
...
<select id="narrowCategorys" name="narrowCategorys">
...
t1.onchange = function() {
  ...
  xhr.open("GET", "../../jsp/learning/district.jsp?sido=" + t1.value, false);
  xhr.send();
...
t3.onchange = function() {
  var xhr = new XMLHttpRequest();
  xhr.open("GET", "../../jsp/learning/category.jsp?broadCategory=" + t3.value, false);
  xhr.send();
