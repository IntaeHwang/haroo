...
-- 대댓글
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_recomment` RESTRICT;

-- 대댓글좋아요
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_recom_like` RESTRICT;

-- 대분류
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_broad_cat` RESTRICT;

-- 댓글
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_comment` RESTRICT;

-- 댓글좋아요
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_com_like` RESTRICT;

-- 상품구매
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_purchase` RESTRICT;

-- 상품구매후기
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_prrv` RESTRICT;

-- 상품장바구니
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_pr_cart` RESTRICT;

-- 서비스기본정보
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_service` RESTRICT;

-- 서비스문의글
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_sqna` RESTRICT;

-- 서비스문의답글파일
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_srpl_file` RESTRICT;

-- 소분류
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_narrow_cat` RESTRICT;

-- 수업일정
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_schedule` RESTRICT;

-- 스토리게시판
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_feed` RESTRICT;

-- 스토리좋아요
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_feed_like` RESTRICT;

-- 시군구
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_sigungu` RESTRICT;

-- 위시리스트
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_wishlist` RESTRICT;

-- 체험장바구니
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_lrn_cart` RESTRICT;

-- 체험학습
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_learning` RESTRICT;

-- 체험학습신청
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_lrn_appl` RESTRICT;

-- 체험학습후기
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_lrnrv` RESTRICT;

-- 체험후기추천수
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_lrnrv_rcm` RESTRICT;

-- 튜터
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_tutor` RESTRICT;

-- 튜터문의게시판
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_tqna` RESTRICT;

-- 튜터문의답글파일
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_trpl_file` RESTRICT;

-- 튜터지역
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_tdist` RESTRICT;

-- 튜터카테고리
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_tcat` RESTRICT;

-- 파일
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_file` RESTRICT;

-- 판매상품
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_product` RESTRICT;

-- 판매상품사진
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_prpic` RESTRICT;

-- 판매상품옵션
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_pr_opt` RESTRICT;

-- 판매상품후기추천수
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_prrv_rcm` RESTRICT;

-- 팔로우
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_follow` RESTRICT;

-- 회원
DROP TABLE IF EXISTS `MY_SCHEMA`.`har_member` RESTRICT;
...
-- 글
ALTER TABLE `MY_SCHEMA`.`har_post`
...
-- 대댓글
CREATE TABLE `MY_SCHEMA`.`har_recomment` (
...
-- 대댓글
ALTER TABLE `MY_SCHEMA`.`har_recomment`
...
-- 대댓글좋아요
CREATE TABLE `MY_SCHEMA`.`har_recom_like` (
  `recom_no` INTEGER NOT NULL COMMENT '대댓글번호', -- 대댓글번호
...
-- 대댓글좋아요
ALTER TABLE `MY_SCHEMA`.`har_recom_like`
...
-- 대분류
CREATE TABLE `MY_SCHEMA`.`har_broad_cat` (
...
-- 대분류
ALTER TABLE `MY_SCHEMA`.`har_broad_cat`
...
CREATE UNIQUE INDEX `UIX_har_broad_cat`
  ON `MY_SCHEMA`.`har_broad_cat` ( -- 대분류
    `bcat_name` ASC -- 대분류명
  );
...
-- 댓글
CREATE TABLE `MY_SCHEMA`.`har_comment` (
  `com_no`   INTEGER  NOT NULL COMMENT '댓글번호', -- 댓글번호
...
-- 댓글
ALTER TABLE `MY_SCHEMA`.`har_comment`
...
-- 댓글좋아요
CREATE TABLE `MY_SCHEMA`.`har_com_like` (
  `com_no` INTEGER NOT NULL COMMENT '댓글번호', -- 댓글번호
  `mno`    INTEGER NOT NULL COMMENT '회원번호' -- 회원번호
)
COMMENT '댓글좋아요';
...
-- 댓글좋아요
ALTER TABLE `MY_SCHEMA`.`har_com_like`
...
-- 상품구매
CREATE TABLE `MY_SCHEMA`.`har_purchase` (
...
CREATE UNIQUE INDEX `UIX_har_purchase`
  ON `MY_SCHEMA`.`har_purchase` ( -- 상품구매
    `invoice_no` ASC -- 송장번호
  );
...
-- 상품구매후기
CREATE TABLE `MY_SCHEMA`.`har_prrv` (
  `pno`     INTEGER      NOT NULL COMMENT '글번호', -- 글번호
  `purc_no` INTEGER      NOT NULL COMMENT '상품옵션구매번호', -- 상품옵션구매번호
...
-- 상품구매후기
ALTER TABLE `MY_SCHEMA`.`har_prrv`
...
-- 상품장바구니
CREATE TABLE `MY_SCHEMA`.`har_pr_cart` (
  `mno`    INTEGER NOT NULL COMMENT '회원번호', -- 회원번호
  `opt_no` INTEGER NOT NULL COMMENT '상품옵션번호', -- 상품옵션번호
...
-- 상품장바구니
ALTER TABLE `MY_SCHEMA`.`har_pr_cart`
...
-- 서비스기본정보
CREATE TABLE `MY_SCHEMA`.`har_service` (
...
-- 서비스기본정보
ALTER TABLE `MY_SCHEMA`.`har_service`
...
-- 서비스문의글
CREATE TABLE `MY_SCHEMA`.`har_sqna` (
  `pno`         INTEGER      NOT NULL COMMENT '글번호', -- 글번호
  `mno`         INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
  `sno`         INTEGER      NOT NULL COMMENT '서비스번호', -- 서비스번호
  `title`       VARCHAR(255) NOT NULL COMMENT '제목', -- 제목
...
-- 서비스문의글
ALTER TABLE `MY_SCHEMA`.`har_sqna`
...
-- 서비스문의답글파일
ALTER TABLE `MY_SCHEMA`.`har_srpl_file`
...
-- 소분류
CREATE TABLE `MY_SCHEMA`.`har_narrow_cat` (
  `ncat_no`   INTEGER     NOT NULL COMMENT '소분류번호', -- 소분류번호
...
-- 소분류
ALTER TABLE `MY_SCHEMA`.`har_narrow_cat`
...
-- 수업일정
CREATE TABLE `MY_SCHEMA`.`har_schedule` (
...
-- 수업일정
ALTER TABLE `MY_SCHEMA`.`har_schedule`
...
CREATE UNIQUE INDEX `UIX_har_schedule`
  ON `MY_SCHEMA`.`har_schedule` ( -- 수업일정
    `stm` ASC,  -- 시작시각
    `etm` ASC,  -- 종료시각
    `date` ASC  -- 날짜
  );
...
-- 스토리게시판
CREATE TABLE `MY_SCHEMA`.`har_feed` (
  `feed_no` INTEGER NOT NULL COMMENT '글번호', -- 글번호
...
-- 스토리게시판
ALTER TABLE `MY_SCHEMA`.`har_feed`
...
-- 스토리좋아요
CREATE TABLE `MY_SCHEMA`.`har_feed_like` (
  `feed_no` INTEGER NOT NULL COMMENT '글번호', -- 글번호
  `mno`     INTEGER NOT NULL COMMENT '회원번호' -- 회원번호
)
COMMENT '스토리좋아요';
...
-- 스토리좋아요
ALTER TABLE `MY_SCHEMA`.`har_feed_like`
...
-- 위시리스트
CREATE TABLE `MY_SCHEMA`.`har_wishlist` (
  `mno` INTEGER NOT NULL COMMENT '회원번호', -- 회원번호
  `sno` INTEGER NOT NULL COMMENT '서비스번호' -- 서비스번호
)
COMMENT '위시리스트';
...
-- 위시리스트
ALTER TABLE `MY_SCHEMA`.`har_wishlist`
...
-- 체험장바구니
CREATE TABLE `MY_SCHEMA`.`har_lrn_cart` (
  `mno`       INTEGER NOT NULL COMMENT '회원번호', -- 회원번호
  `sche_no`   INTEGER NOT NULL COMMENT '수업일정번호', -- 수업일정번호
...
-- 체험장바구니
ALTER TABLE `MY_SCHEMA`.`har_lrn_cart`
...
-- 체험학습
CREATE TABLE `MY_SCHEMA`.`har_learning` (
  `lno`        INTEGER      NOT NULL COMMENT '체험학습번호', -- 체험학습번호
  `sgg_no`     INTEGER      NOT NULL COMMENT '시군구번호', -- 시군구번호
...
-- 체험학습
ALTER TABLE `MY_SCHEMA`.`har_learning`
...
-- 체험학습신청
CREATE TABLE `MY_SCHEMA`.`har_lrn_appl` (
...
-- 체험학습신청
ALTER TABLE `MY_SCHEMA`.`har_lrn_appl`
...
-- 체험학습후기
CREATE TABLE `MY_SCHEMA`.`har_lrnrv` (
  `pno`         INTEGER      NOT NULL COMMENT '글번호', -- 글번호
  `lrn_appl_no` INTEGER      NOT NULL COMMENT '체험학습신청번호', -- 체험학습신청번호
  `title`       VARCHAR(255) NOT NULL COMMENT '제목', -- 제목
  `rate`        DOUBLE       NOT NULL DEFAULT 1 COMMENT '평점' -- 평점
...
-- 체험학습후기
ALTER TABLE `MY_SCHEMA`.`har_lrnrv`
...
CREATE UNIQUE INDEX `UIX_har_lrnrv`
  ON `MY_SCHEMA`.`har_lrnrv` ( -- 체험학습후기
    `lrn_appl_no` ASC -- 체험학습신청번호
  );

-- 체험후기추천수
CREATE TABLE `MY_SCHEMA`.`har_lrnrv_rcm` (
  `mno` INTEGER NOT NULL COMMENT '회원번호', -- 회원번호
  `pno` INTEGER NOT NULL COMMENT '글번호' -- 글번호
)
COMMENT '체험후기추천수';
...
-- 체험후기추천수
ALTER TABLE `MY_SCHEMA`.`har_lrnrv_rcm`
...
-- 튜터
ALTER TABLE `MY_SCHEMA`.`har_tutor`
...
-- 튜터문의게시판
CREATE TABLE `MY_SCHEMA`.`har_tqna` (
  `pno`      INTEGER      NOT NULL COMMENT '글번호', -- 글번호
  `mno`      INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
  `tno`      INTEGER      NOT NULL COMMENT '튜터번호', -- 튜터번호
  `title`    VARCHAR(255) NOT NULL COMMENT '제목', -- 제목
...
-- 튜터문의게시판
ALTER TABLE `MY_SCHEMA`.`har_tqna`
...
-- 튜터문의답글파일
ALTER TABLE `MY_SCHEMA`.`har_trpl_file`
...
-- 튜터지역
CREATE TABLE `MY_SCHEMA`.`har_tdist` (
  `tno`    INTEGER NOT NULL COMMENT '튜터번호', -- 튜터번호
  `sgg_no` INTEGER NOT NULL COMMENT '시군구번호' -- 시군구번호
)
COMMENT '튜터지역';
...
-- 튜터카테고리
CREATE TABLE `MY_SCHEMA`.`har_tcat` (
  `ncat_no` INTEGER NOT NULL COMMENT '소분류번호', -- 소분류번호
  `tno`     INTEGER NOT NULL COMMENT '튜터번호' -- 튜터번호
)
COMMENT '튜터카테고리';
...
-- 튜터카테고리
ALTER TABLE `MY_SCHEMA`.`har_tcat`
...
-- 파일
ALTER TABLE `MY_SCHEMA`.`har_file`
...
-- 판매상품후기추천수
CREATE TABLE `MY_SCHEMA`.`har_prrv_rcm` (
  `mno` INTEGER NOT NULL COMMENT '회원번호', -- 회원번호
  `pno` INTEGER NOT NULL COMMENT '글번호' -- 글번호
)
COMMENT '판매상품후기추천수';
...
-- 판매상품후기추천수
ALTER TABLE `MY_SCHEMA`.`har_prrv_rcm`
...
-- 팔로우
CREATE TABLE `MY_SCHEMA`.`har_follow` (
  `mno` INTEGER NOT NULL COMMENT '회원번호', -- 회원번호
  `tno` INTEGER NOT NULL COMMENT '튜터번호' -- 튜터번호
)
COMMENT '팔로우';
...
-- 팔로우
ALTER TABLE `MY_SCHEMA`.`har_follow`
...
-- 회원
CREATE TABLE `MY_SCHEMA`.`har_member` (
  `mno`         INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
...
-- 회원
ALTER TABLE `MY_SCHEMA`.`har_member`
...
-- 회원등급
CREATE TABLE `MY_SCHEMA`.`har_mrank` (
  `mrno`     INTEGER     NOT NULL COMMENT '회원등급번호', -- 회원등급번호
...
-- 회원등급
ALTER TABLE `MY_SCHEMA`.`har_mrank`
...
ALTER TABLE `MY_SCHEMA`.`har_recomment`
  ADD CONSTRAINT `FK_har_comment_TO_har_recomment` -- 댓글 -> 대댓글
    ...
    REFERENCES `MY_SCHEMA`.`har_comment` ( -- 댓글
      `com_no` -- 댓글번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_recomment`
  ADD CONSTRAINT `FK_har_member_TO_har_recomment` -- 회원 -> 대댓글
    ...
    REFERENCES `MY_SCHEMA`.`har_member` ( -- 회원
      `mno` -- 회원번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_recom_like`
  ADD CONSTRAINT `FK_har_recomment_TO_har_recom_like` -- 대댓글 -> 대댓글좋아요
    ...
    REFERENCES `MY_SCHEMA`.`har_recomment` ( -- 대댓글
      `recom_no` -- 대댓글번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_comment`
  ADD CONSTRAINT `FK_har_feed_TO_har_comment` -- 스토리게시판 -> 댓글
    ...
    REFERENCES `MY_SCHEMA`.`har_feed` ( -- 스토리게시판
      `feed_no` -- 글번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_purchase`
  ADD CONSTRAINT `FK_har_pr_opt_TO_har_purchase` -- 판매상품옵션 -> 상품구매
    ...
    REFERENCES `MY_SCHEMA`.`har_pr_opt` ( -- 판매상품옵션
      `opt_no` -- 상품옵션번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_prrv`
  ADD CONSTRAINT `FK_har_post_TO_har_prrv` -- 글 -> 상품구매후기
    ...
    REFERENCES `MY_SCHEMA`.`har_post` ( -- 글
      `pno` -- 글번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_prrv`
  ADD CONSTRAINT `FK_har_purchase_TO_har_prrv` -- 상품구매 -> 상품구매후기
    ...
    REFERENCES `MY_SCHEMA`.`har_purchase` ( -- 상품구매
      `purc_no` -- 상품옵션구매번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_service`
  ADD CONSTRAINT `FK_har_narrow_cat_TO_har_service` -- 소분류 -> 서비스기본정보
    ...
    REFERENCES `MY_SCHEMA`.`har_narrow_cat` ( -- 소분류
      `ncat_no` -- 소분류번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_srpl_file`
  ADD CONSTRAINT `FK_har_sqna_TO_har_srpl_file` -- 서비스문의글 -> 서비스문의답글파일
    ...
    REFERENCES `MY_SCHEMA`.`har_sqna` ( -- 서비스문의글
      `pno` -- 글번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_narrow_cat`
  ADD CONSTRAINT `FK_har_broad_cat_TO_har_narrow_cat` -- 대분류 -> 소분류
    ...
    REFERENCES `MY_SCHEMA`.`har_broad_cat` ( -- 대분류
      `bcat_no` -- 대분류번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_schedule`
  ADD CONSTRAINT `FK_har_learning_TO_har_schedule` -- 체험학습 -> 수업일정
    ...
    REFERENCES `MY_SCHEMA`.`har_learning` ( -- 체험학습
      `lno` -- 체험학습번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_feed`
  ADD CONSTRAINT `FK_har_tutor_TO_har_feed` -- 튜터 -> 스토리게시판
    ...
    REFERENCES `MY_SCHEMA`.`har_tutor` ( -- 튜터
      `tno` -- 튜터번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_lrn_cart`
  ADD CONSTRAINT `FK_har_schedule_TO_har_lrn_cart` -- 수업일정 -> 체험장바구니
    ...
    REFERENCES `MY_SCHEMA`.`har_schedule` ( -- 수업일정
      `sche_no` -- 수업일정번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_learning`
  ADD CONSTRAINT `FK_har_sigungu_TO_har_learning` -- 시군구 -> 체험학습
    ...
    REFERENCES `MY_SCHEMA`.`har_sigungu` ( -- 시군구
      `sgg_no` -- 시군구번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_lrnrv`
  ADD CONSTRAINT `FK_har_lrn_appl_TO_har_lrnrv` -- 체험학습신청 -> 체험학습후기
    ...
    REFERENCES `MY_SCHEMA`.`har_lrn_appl` ( -- 체험학습신청
      `lrn_appl_no` -- 체험학습신청번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_lrnrv_rcm`
  ADD CONSTRAINT `FK_har_lrnrv_TO_har_lrnrv_rcm` -- 체험학습후기 -> 체험후기추천수
    ...
    REFERENCES `MY_SCHEMA`.`har_lrnrv` ( -- 체험학습후기
      `pno` -- 글번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_trpl_file`
  ADD CONSTRAINT `FK_har_tqna_TO_har_trpl_file` -- 튜터문의게시판 -> 튜터문의답글파일
    ...
    REFERENCES `MY_SCHEMA`.`har_tqna` ( -- 튜터문의게시판
      `pno` -- 글번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_prrv_rcm`
  ADD CONSTRAINT `FK_har_prrv_TO_har_prrv_rcm` -- 상품구매후기 -> 판매상품후기추천수
    ...
    REFERENCES `MY_SCHEMA`.`har_prrv` ( -- 상품구매후기
      `pno` -- 글번호
    );
...
ALTER TABLE `MY_SCHEMA`.`har_member`
  ADD CONSTRAINT `FK_har_mrank_TO_har_member` -- 회원등급 -> 회원
    ...
    REFERENCES `MY_SCHEMA`.`har_mrank` ( -- 회원등급
      `mrno` -- 회원등급번호
    );
...
-- 광역시도
insert into har_mcityprov (mcp_no, mcp_name)
values (1, '서울'); -- 특별시
insert into har_mcityprov (mcp_no, mcp_name)
values (2, '경기');
insert into har_mcityprov (mcp_no, mcp_name)
...
-- 시군구
-- 서울
insert into har_sigungu (sgg_no, mcp_no, sgg_name)
values (1, 1, '도봉구');
insert into har_sigungu (sgg_no, mcp_no, sgg_name)
values (2, 1, '노원구');
insert into har_sigungu (sgg_no, mcp_no, sgg_name)
